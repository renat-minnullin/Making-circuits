...
---Важно!
    ...
    3) Направление ветви должно быть только у провода, но не у прикрпленного к нему элемента
---Cтоп-мысли: 
     * ПРОВЕРКА ВЕТВЕЙ ДОЛЖНА ПРОИСХОДИТЬ ПРИ СОЗДАНИИ КАЖДОГО ПРОВОДА
     
     - При создании элемента на проводе с выставленным током, ток исчезает (!!!!!!!!!)
     - При задании направления ветви, выбирается направление last и first, но у каждого элемента в ветви оно может не 
     совпадать с направлением ветви, т.к. элемент мог дорисовываться в другом направлении
